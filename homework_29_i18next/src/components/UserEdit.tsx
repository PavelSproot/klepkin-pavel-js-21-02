  ...
  const handleUserEditForm = (): void => {
    editUserForm
      ...
      .then((fields) => {
        ...
        if (fields.birthday) {
          user.dateOfBirth = moment(fields.birthday, dateFormat).format('YYYY-MM-DD');
        }
                        ...
                        <div className="userEdit__main-container">
                          <Form
                            ...
                            initialValues={{
                              ...
                              birthday: moment(userProfile.dateOfBirth && makeDigitDateFromISO(userProfile.dateOfBirth), dateFormat),
                            ...
                            <Form.Item label={t('title_birthday')} name="birthday">
                              <div className="userEdit__birthday-container">
                                <ConfigProvider locale={locale}>
                                  <DatePicker className="userEdit__birthday" locale={loc} format={dateFormat} placeholder={t('ph_birthday')} defaultValue={moment(userProfile.dateOfBirth && makeDigitDateFromISO(userProfile.dateOfBirth), dateFormat)} />
                                </ConfigProvider>
                              </div>
                            </Form.Item>
                            <Form.Item
